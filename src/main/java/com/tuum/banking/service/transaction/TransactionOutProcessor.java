...
@Service
public class TransactionOutProcessor implements TransactionProcessor {
    ...
    public TransactionResult process(TransactionCreateRequest request) {
        ...
        var currentBalance = balanceService.decreaseBalance(request.getAccountId(), Currency.valueOf(request.getCurrency()), request.getAmount());
